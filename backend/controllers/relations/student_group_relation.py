...
class StudentGroupRelationController:
    def get_one_student_all_groups(self,student_id):
        groups=StudentGroupRelation.query.join(GroupProject).\
                filter(GroupProject.group_id==StudentGroupRelation.group_id).filter(StudentGroupRelation.student_id==student_id)\
                .with_entities(GroupProject.group_name,GroupProject.group_name,GroupProject.group_id,GroupProject.group_description,GroupProject.post_owner_id, GroupProject.group_pic)
