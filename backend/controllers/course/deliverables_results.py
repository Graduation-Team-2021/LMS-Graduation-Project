...
class deliverable_results_controller:
    ...
    def get_deliverable_result(self, deliverable_id, user_id):
        try:
            ...
            deliverable_result = Deliverables_Results.query.filter(
                Deliverables_Results.deliverable_id == deliverable_id).filter(
    ...
    def update_deliverable_result(self, new_deliverable_result):
        try:
            deliverable_result = self.get_deliverable_result(new_deliverable_result['deliverable_id'],
                                                             new_deliverable_result['user_id'])
