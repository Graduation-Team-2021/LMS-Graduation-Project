...
import AddCourseField from "../../Components/AddCourseField/AddCourseField";
...
class AddCoursePage extends Component {
  ...
  changeInput = (event) => {
    ...
    this.setState((prevState) => {
      return {
        Error: { ...prevState.Error, [event.target.name + "Error"]: x },
        Data: {
          ...prevState.Data,
          [event.target.name]:
    ...
    // if (this.state.Error[event.target.name + "Error"]) {
    //   this.setState({
